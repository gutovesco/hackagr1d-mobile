                          ...
                          child: new Row(
                            ...
                            children: <Widget>[
                              new Flexible(
                                child: new TextField(
                                  decoration: const InputDecoration(
                                      hintText: "Rua da segurança, 111 - Parque dos Segurados"),
                                  enabled: !_status,
                                ),
                              ),
                            ],
              ...
              child: Container(
                ...
                onPressed: () {
                  Alert(
                    ...
                    desc: 'Lembre-se: mantendo seus dados cadastrais em dia, mais oportunidades estarão disponíveis para seu perfil!',
                    buttons: [
                      DialogButton(
                        color: Colors.green,
                        width: 200.0,
